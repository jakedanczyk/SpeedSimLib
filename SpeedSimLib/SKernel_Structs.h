...
enum ITEM_TYPE
{
	...
	// ships
	T_KT = 0,       /*!< 0Small Cargo Ship */
	T_GT,           /*!< 1Large Cargo Ship */
	T_LJ,           /*!< 2Light Fighter */
	T_SJ,           /*!< 3Heavy Fighter */
	T_KREUZER,      /*!< 4Cruiser */
	T_SS,           /*!< 5Battle Ship */
	T_KOLO,         /*!< 6Colony Ship */
	T_REC,          /*!< 7Recycler */
	T_SPIO,         /*!< 8Espionage Probe */
	T_BOMBER,       /*!< 9Bomber */
	T_SAT,          /*!< 10Solar Satellite */
	T_ZER,          /*!< 11Destroyer */
	T_TS,           /*!< 12Death Star */
    T_IC,           /*!< 13Interceptor */

    // defense
	T_RAK,          /*!< 14Missile Launcher */
	T_LL,           /*!< 15Small Laser */
	T_SL,           /*!< 16Heavy Laser */
	T_GAUSS,        /*!< 17Gauss Cannon */
	T_IONEN,        /*!< 18Ion Cannon */
	T_PLASMA,       /*!< 19Plasma Cannon */
	T_KS,           /*!< 20Small Shield Dome */
	T_GS,           /*!< 21Large Shield Dome */
